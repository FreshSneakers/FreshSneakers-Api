module.exports.generatePassword = (email, token) => {
  return `
  <!doctype html>
  ...
  @media only screen and (max-width:480px) {
    ...
    <img alt="header image" height="auto" src="https://images.unsplash.com/photo-1588273566196-1806ae82a07b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" width="600">
    ...
    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
      <tr>
        <td align="center" bgcolor="#f48403" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#f48403;" valign="middle">
          <a href="${ `http://localhost:${3000}`}/edit-password" style="display: inline-block; background: #f48403; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 120%; margin: 0; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px; text-decoration: none; color: inherit;" target="_blank">
