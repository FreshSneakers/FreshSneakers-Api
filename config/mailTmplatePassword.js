module.exports.generateTemplate = (email, token) => {
    ...
    @media only screen and (max-width:480px) {
      ...
      <img alt="header image" height="auto" src="https://images.unsplash.com/photo-1597248881519-db089d3744a5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" width="600">
