const sneakers= [
    {
        ...
        description:'If you thought patent leather was reserved only for the Air Jordan 11, you havent met the Air Jordan 1 Retro Black Gold Patent from 2013. With a completely patent leather upper, the glossy finish accentuated the gold details on this AJ1 like the Swoosh, Wings logo, and Nike Air patch on the tongue. Some of the best additions to this Air Jordan 1 Retro are the translucent gum outsole with gold speckles and the gold stitching along the midsole. This 2013 Air Jordan 1 Retro Black Gold Patent was a rework of an Air Jordan 1 Mid that released in 2003 as part of the Patent Pack. That Air Jordan 1 has less gold, a black midsole and outsole, and was the last Air Jordan 1 Retro to come with a Jumpman keychain. An old rumor has it that a pair of the 2003 original once fetched $30,000 on eBay. This Air Jordan 1 Retro Black Gold Patent debuted in April of 2013 as a limited release in a year that saw over 25 Air Jordan 1s in low, mid, and high form hit retail shelves. With its premium make up and low production numbers, the Air Jordan 1 Retro Black Gold Patent stood out from the crowd that year',
        price:1493,
    ...
    },
    {
        ...
        description:'Jordan Brand revamped a classic silhouette with the release of the Jordan 1 Retro High Zoom White Racer Blue, now available on StockX. Nike Zoom technology is incorporated in this design for the ultimate cushioning experience.',
        price:1093,
    ...
    },
    {
        ...
        description:'Jordan Brand connected with Parisian fashion house Dior to create history with the Jordan 1 Retro Low Dior, now available on StockX. This is the first time that Jordan has collaborated with a legacy fashion label like Dior, making this release one for the books. This release was limited to only 4,700 pairs, each pair individually numbered.',
        price:5.141,
    ...
    },
    {
        ...
        color:'core white/core white/core white'
    },
    {
        brand:'Adidas',
    ...
    },
    {
        ...
        color:' orange/collegiate royal/hi-res red'
    },
    {
        brand:'Adidas',
    ...
    },
    {
        ...
        color:'white/metalic smmt white-tm'

    },
    {
        brand:'Nike',
        model:'Nike SUPREME X NBA X AIR FORCE 1 MID 07',
        description:'If you thought patent leather was reserved only for the Air Jordan 11, you havent met the Air Jordan 1 Retro Black Gold Patent from 2013. With a completely patent leather upper.',
        price:6000,
        image:'https://cdn.flightclub.com/1500/TEMPLATE/803497/1.jpg',
        color:'black/blac'
    ...
    },
    {
        ...
        color:'summit white/hyper cobalt-white'
